...
export function FeaturesSection({ className, ...props }: ComponentProps<'section'>) {
  return (
    <section
      className={cn('bg-white text-[#242437]', 'flex flex-col items-center', 'py-16 tablet:py-[160px]','px-4', className)}
      {...props}
    >
      ...
      <ul className={cn("mt-12 tablet:mt-20", "grid gap-6","tablet:grid-cols-1 tablet:px-16", "desktop:grid-cols-[repeat(2,528px)]",)}>
        ...
        >
          <div className="px-6 tablet:px-8">
            <h4 className="tracking-[-3%] font-semibold text-xl tablet:text-2xl">Mobile tracking</h4>
            <p className="tracking-[-2%] text-sm mt-4 tablet:mt-6 leading-[1.5]">
        ...
        >
          <div className="px-6 tablet:px-8">
            <h4 className="tracking-[-3%] font-semibold text-xl tablet:text-2xl">Doom scroll prevention</h4>
            <p className="tracking-[-2%] text-sm mt-4 tablet:mt-6 leading-[1.5]">
